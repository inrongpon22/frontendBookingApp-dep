...
const PhoneInput = () => {
  ...
  return (
    <section>
      ...
      <input
        type="text"
        className={`w-full text-[14px] p-4 rounded-lg my-5 ${formik.touched.phoneNumbers && formik.errors.phoneNumbers
      ...
      >
        ...
        <span
          className={`${isLoading ? "flex items-center justify-center" : "hidden"
            } ms-3`}
        ></span>
      </button>
