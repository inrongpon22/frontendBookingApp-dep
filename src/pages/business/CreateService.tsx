        ...
        >
            ...
            <div className="flex flex-col pr-4 pl-4">
                <div
                    ...
                    <ServiceCard
                        handleEdit={() => setState({ ...state, ['bottom']: true })}
                    />
                    {serviceTime.map((time, index) => (
                        <div onClick={() => props.handleEdit && props.handleEdit(index)} key={index}>
                            <TimeCard
                                index={index}
                                serviceTime={time}
                    ...
                    <div className="w-full flex justify-center bottom-0 inset-y-0 gap-2" style={{ marginTop: serviceTime.length > 0 ? 0 : "100px" }}>
                        <button
